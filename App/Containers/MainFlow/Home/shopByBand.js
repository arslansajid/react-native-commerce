...
class ShopByBrand extends Component {
    constructor(props) {
        ...
        this.state = {
            categories: [
                { title: 'K&C', image: images.waffleStack2, selected: true },
                { title: 'INN Waffle', image: images.waffleStack, selected: false },
                { title: 'Malmo', image: images.waffleStack3, selected: true },
                { title: 'Gormet', image: images.waffleStack4, selected: true },
                { title: 'US Bak', image: images.waffleStack5, selected: true },
            ],
            products: [
